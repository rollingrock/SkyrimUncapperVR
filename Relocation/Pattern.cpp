...
//	_MESSAGE("maskstr: %s", m_mask.c_str());
...
//			m_numMatches++;
	...
	//if (m_numMatches > m_maxMatches) {
	//	m_maxMatches = m_numMatches;
	//	char * ptr2 = reinterpret_cast<char*>(offset);
...
//	_MESSAGE("memstr %s", memstr.c_str());
//	_MESSAGE("maskSize = %d ; numMatches = %d", m_size, m_maxMatches);
